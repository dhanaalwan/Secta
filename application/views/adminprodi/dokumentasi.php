...
<table class="table">
	...
	<tbody>
		...
		<td>
			<?= anchor('ControllerGlobal/downloadFile/TugasAkhir/'.$u->FileTugasAkhir, '<i class="fas fa-download"></i>') ?>
		</td>
		<td>
			<?= $u->Nilai ?>
		</td>
...
<?php } else { ?>
		<div class='row align-items-center'>
			<div class="col-md mb-5">
				...
				Mohon maaf saat ini tidak ditemukan dokumentasi untuk bidang minat ini.
			</div>
			<div class="col-md-3">
