    ...
    <div class="col-md-4">
      <form class="mb-3" id="pass_admin" method="post" action="<?= base_url('ControllerGlobal/ubahPassword/'.$this->session->userdata('id_admin').'/admin');?>">
        ...
        <div class="form-group">
          <label for="exampleInputEmail1">NPM/NIP</label>
          <input type="text" class="form-control" id="username" placeholder="NPM/NIP" name="username">
        </div>
        <div class="form-group">
        ...
        <button type="submit" class="btn btn-primary btn-pass">Simpan</button>
      </form> 
    </div>
